...
class AttentionNeuron(BaseClass):
    ...
    def compute_excitatory_drive(
        ...
        **kwargs
        ...
        if 'attention_simulate_external_drive' in kwargs.keys():
            ext_drive = kwargs['attention_simulate_external_drive']
            if self.orientation == 1:
                response_difference = response_same_orientation - response_other_orientation + ext_drive[0]
            else:
                # response_difference = response_same_orientation - response_other_orientation - 0.1
                response_difference = response_same_orientation - response_other_orientation + ext_drive[1]
            #
        else:
